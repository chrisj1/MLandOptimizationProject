...
for test in tests:
    ...
    ax1.set_title('Rank {} CPDMWU on {}x{}x{} with sketching rate(s)\n{}\ntrial number {}'.format(Rank, Size,Size,Size,fiberPropotion,trial))
    print('{}/CPDMWU{}{}{}.png'.format(plotsDirectoryEach,Size,fiberPropotion,trial))
    plt.savefig('{}/CPDMWU{}{}{}{}.png'.format(plotsDirectoryEach,Size,Rank,fiberPropotion,trial))
    plt.close()
...
for test in tests:
    ...
    plt.savefig('{}/CPDMWUFibersSelected{}{}{}{}.png'.format(plotsDirectoryEach,Size,Rank,fiberPropotion,trial))
    plt.close()
