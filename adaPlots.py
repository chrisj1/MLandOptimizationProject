...
for test in tests:
    ...
    ax1.set_title('AdaCPD on {}x{}x{} with {} propotion of fibers sampled\ntrial number {}'.format(Size,Size,Size,fiberPropotion,trial))

    plt.savefig('{}/AdaCPD{}{}{}.png'.format(plotsDirectoryEach,Size,fiberPropotion,trial))
    plt.close()
