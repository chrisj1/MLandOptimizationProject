...
for i in range(trials):
    ...
    sketching_rates = [(1, False)]  # Normal ALS
    ...
    sketching_rates = [(1, True)]  # Sample full gradient
    ...
    errors_adagrad_1.append(NRE_A[list(NRE_A.keys())[-1]])

    sketching_rates = [(0.5, True)]  # sample half the gradient
...
print(stats(errors_sketechedALS_1))
print(stats(errors_sketechedALS))
print(stats(errors_both))
print(stats(errors_adagrad_1))
print(stats(errors_adagrad_5))
